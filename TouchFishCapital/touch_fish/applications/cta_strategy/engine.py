...
from touch_fish.utils.engine import BaseEngine, MainEngine
from touch_fish.utils.object import (
    OrderRequest,
    SubscribeRequest,
    HistoryRequest,
    LogData,
...
from touch_fish.utils.event import (
    EVENT_TICK,
    EVENT_ORDER,
    EVENT_TRADE,
    EVENT_POSITION
)
from touch_fish.utils.constant import (
    Direction,
    OrderType,
    Interval,
    Exchange,
...
from touch_fish.utils.utility import load_json, save_json, extract_vt_symbol, round_to
from touch_fish.utils.converter import OffsetConverter
from touch_fish.utils.database import database_manager
...
class CtaEngine(BaseEngine):
    ...
    def load_strategy_class(self):
        ...
        self.load_strategy_class_from_folder(
            path1, "touch_fish.applications.cta_strategy.strategies")
