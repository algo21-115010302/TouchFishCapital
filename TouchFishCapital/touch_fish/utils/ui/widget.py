...
class TradeMonitor(BaseMonitor):
    ...
    headers: Dict[str, dict] = {
        ...
        "order_price": {"display": "委托价格", "cell": BaseCell, "update": True},
        "price": {"display": "价格", "cell": BaseCell, "update": False},
        "volume": {"display": "数量", "cell": BaseCell, "update": False},
        "trading_cost": {"display": "交易成本", "cell": BaseCell, "update": True},
...
class OrderMonitor(BaseMonitor):
    ...
    headers: Dict[str, dict] = {
        ...
        "datetime": {"display": "时间", "cell": TimeCell, "update": True},
        "avg_trade_price": {"display": "平均成交价格", "cell": BaseCell, "update": True},
        "trading_cost": {"display": "交易成本", "cell": BaseCell, "update": True},
        "slippage": {"display": "滑点", "cell": BaseCell, "update": True},
        "gateway_name": {"display": "接口", "cell": BaseCell, "update": False},
    }
