"""
Basic data structure used for general trading function in TF Trader.
"""
...
class OrderData(BaseData):
    ...
    avg_trade_price: float = None  # Average trading price for each order till this trade
...
class TradeData(BaseData):
    ...
    orderid: str
    tradeid: str
    order_price : float = None # Order price of this trade
    direction: Direction = None
